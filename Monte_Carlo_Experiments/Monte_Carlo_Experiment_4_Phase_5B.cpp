...
//
// Phase 5B diagnostic:
// Advance Earth and Mars from the J2000.0 baseline to a
// deterministic shared simulation epoch using published JPL
// approximate Keplerian elements and rates, while preserving
// the matched B1-B4 Monte Carlo world design.
//
...
// shared epoch using their own JPL element rates. Relay orbits
// remain intentionally deferred to a later subphase.
// ============================================================
...
int main()
{
    ...
    std::cout
        << "PHASE 5B - DYNAMIC EARTH/MARS 3-D GEOMETRY\n";
