...
//
// Phase 11B full-pilot counterfactual validation:
...
int main()
{
    ...
    // Full pilot counterfactual validation: all 100 matched pilot worlds.
    const int Number_Of_Debug_Trials = 100;

    const std::uint32_t Base_Seed = PHASE_10_PILOT_SEED_FIRST;
    ...
    const std::string Results_Folder =
        "./"
        "Monte_Carlo_Experiment 4/Phase_11B_Full_Pilot_Counterfactual";
    ...
    const std::string Matching_File_Name =
        Results_Folder +
        "/Phase11B_RQ4_Matching_Check.csv";
    ...
    const std::string Diagnostic_File_Name =
        Results_Folder +
        "/Phase11B_Full_Pilot_Score_and_Counterfactual_Validation.csv";
    ...
    Phase10_Record_Check(Phase10_Result,"TEST 15 - Phase 11B full-pilot diagnostic exists and is nonempty",Phase10_File_Exists_And_Nonempty(Diagnostic_File_Name));
    ...
    std::cout
        << "Phase 11B full-pilot diagnostic file:\n"
        << Diagnostic_File_Name
        << "\n\n";


    std::cout<<"For each Trial/Seed, B1-B4 retain identical shared-world, route-state, packet-release, and shared contact inputs.\n";
    std::cout<<"NOTE: This is full-pilot counterfactual validation. Frozen Phase 10 physics and packet mechanics remain unchanged.\n";
    std::cout<<"\n====================================================\nPHASE 11B FULL-PILOT INTEGRITY CHECK\n====================================================\n"
             ...
             <<"PHASE 11B VALIDATION STATUS: "<<(Phase10_Result.Overall_Pass?"PASS":"FAIL")<<"\n";
    if(!Phase10_Result.Overall_Pass) return 1;
